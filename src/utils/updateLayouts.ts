...
function getTargetAttributes(target?: string): [number, string, string] {
    switch (target) {
        case 'Friends and Family':
            return [LAYOUT.radius.friendsAndFamily, LAYOUT.colors.friendsAndFamily.border, LAYOUT.colors.friendsAndFamily.bg];
        case 'Pilot':
            return [LAYOUT.radius.pilot, LAYOUT.colors.pilot.border, LAYOUT.colors.pilot.bg];
        case 'Beta':
            return [LAYOUT.radius.beta, LAYOUT.colors.beta.border, LAYOUT.colors.beta.bg];
        case 'future':
            return [LAYOUT.radius.future, LAYOUT.colors.future.border, LAYOUT.colors.future.bg];
        default:
            return [LAYOUT.radius.friendsAndFamily, LAYOUT.colors.friendsAndFamily.border, LAYOUT.colors.friendsAndFamily.bg];
    }
}
